...
export default function Footer() {
  return (
    <footer className="bg-[#111827] h-[160px] ">
      <div className="flex items-center justify-between pt-[32px] lg:w-[1120px] md:w-[696px] mx-auto">
        <p className="text-gray_400 font-normal text-[16px] leading-[19.09px] tracking-[0%] text-center">©codeit - 2024</p>
        <div className="flex gap-[30px] font-normal text-[16px] leading-[19.09px] tracking-[0%] text-center">
          <p className="text-gray_200">Privacy Policy</p>
          <p className="text-gray_200">FAQ</p>
        </div>
