...
export const visibleOn = (e) => {
    ...
    input.type = input.classList.contains("active_visible") ? "text" : "password";
    btn.src = input.classList.contains("active_visible") ? "./assets/btn_visibility_on.svg" : "./assets/btn_visibility_off.svg";
}