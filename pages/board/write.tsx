  ...
  return(
    <form className="flex flex-col gap-[32px] w-[100%] mb-[500px]">
      ...
      <div className="flex flex-col gap-3">
        ...
        <input placeholder="제목을 입력해주세요" className="focus:outline-[#3692FF] bg-[#F3F4F6] w-[100%] px-[24px] py-[16px] rounded-xl" onChange={handleTitle}/>
      </div>
      <div className="flex flex-col gap-3">
        <div className="font-bold text-[18px]">*내용</div>
        <textarea placeholder="내용을 입력해주세요" className="focus:outline-[#3692FF] bg-[#F3F4F6] w-[100%] px-[24px] py-[16px] rounded-xl min-h-[282px]" onChange={handleContent}/>
      </div>
    </form>
  )
}